...
namespace Fire_Detector.BunifuForm
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            this.OnConnectionChanged           += this.defaultView.OnConnectionChanged;
            this.OnConnectionChanged           += this.defaultView.sideExpandedBar.visualizeTab.OnConnectionChanged;
            this.OnConnectionChanged           += this.mainView.mainConnectionView.OnConnectionChanged;
